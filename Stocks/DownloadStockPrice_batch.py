...
parser = argparse.ArgumentParser(description='Process key parameters for yFinance : period, interval.')
parser.add_argument('-p', default="5y", help="period parameter for yFinance",
                    choices=["1d", "5d", "1mo", "3mo", "6mo", "1y", "2y", "5y", "10y", "ytd", "max"]
                    )

parser.add_argument('-i', default="1d", help="interval parameter for yFinance",
...
filename = 'D:/Temp/data/USMarket/data/US-Price-' + str(date.today()) + "_" + period + "_" + interval +'.pkl'
