...
parser = argparse.ArgumentParser(description='Download YouTube video as MP4 file.')
parser.add_argument('url', type=str, help='The YouTube video URL.')
parser.add_argument('--output-dir', type=str, default='./', help='The output directory for the MP4 file.')
...
ydl_opts = {
    'format': 'best[ext=mp4]/best',  # Get best quality
